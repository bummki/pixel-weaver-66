...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "gradient-primary text-white font-semibold hover:scale-105 hover:shadow-glow active:scale-95",
        destructive: "bg-destructive text-destructive-foreground hover:bg-destructive/90 hover:scale-105 active:scale-95",
        outline: "surface-elevated border border-primary/30 hover:border-primary/50 hover:bg-primary/5 hover:scale-105 active:scale-95",
        secondary: "gradient-secondary text-white font-semibold hover:scale-105 hover:shadow-glow-secondary active:scale-95",
        ...
        glass: "glass hover:bg-primary/10 hover:border-primary/50 hover:scale-105 active:scale-95",
      },
      size: {
